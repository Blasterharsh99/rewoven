...
export default async function ApartmentRequestsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-sky-900 mb-2">Donation Requests</h2>
          <p className="text-sky-700">Manage requests from NGOs for your clothing donations</p>
        </div>
  ...
  <Card className="border-sky-200 bg-white/60 backdrop-blur-sm">
    <CardContent className="text-center py-12">
      ...
      <p className="text-sky-600 mb-6">When NGOs request your clothing donations, they will appear here.</p>
      <Button variant="outline" asChild>
