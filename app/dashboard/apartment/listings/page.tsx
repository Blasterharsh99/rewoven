  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-emerald-900 mb-2">Your Clothing Listings</h2>
          <p className="text-emerald-700">Manage all your clothing donation listings</p>
        </div>
        ...
        {listings && listings.length > 0 ? (
          ...
          <Card className="border-emerald-200 bg-white/60 backdrop-blur-sm">
            <CardContent className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-emerald-900 mb-2">No Listings Yet</h3>
              <p className="text-emerald-600 mb-6">Create your first clothing listing to start helping NGOs in need.</p>
              <Button asChild className="bg-emerald-600 hover:bg-emerald-700">
                <Link href="/dashboard/apartment/listings/new">
                  <Plus className="h-4 w-4 mr-2" />
